...
namespace Sas.Service.Astronomy.Data
{
    internal class ContextSeed : CreateDatabaseIfNotExists<Context>
    {
        protected override void Seed(Context context)
        {
            ...
            ObservatoryEntity Greenwich = new ObservatoryEntity { Id = 1, Name = "Greenwich", Latitude = ChangeDegToRad(51.47781), Longitude = ChangeDegToRad(0.00148) };
            ...
            observations.Add(new ObservationEntity { Id = 1, ObjectName = "Moon", ObservatoryId = 1, CreatedOn = new DateTime(2013, 8, 21, 19, 0, 0), Azimuth = ChangeDegToRad(102.15467), Altitude = ChangeDegToRad(3.343), Distance = 367273905, Observatory = Cracow });
            observations.Add(new ObservationEntity { Id = 1, ObjectName = "Moon", ObservatoryId = 1, CreatedOn = new DateTime(2013, 8, 21, 20, 0, 0), Azimuth = ChangeDegToRad(109.24953), Altitude = ChangeDegToRad(8.868778), Distance = 367004977, Observatory = Greenwich });
